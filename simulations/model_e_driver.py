...
initial_age = model.tau_start # in months

# ### Simple output
# s = model.Society(initial_goats, initial_age)
# print(f"After {0:>2} months: {s.alive_goats}, {sum(s.alive_goats)}, {s.active_families}; {s.families[0].goats[0].preg}")

# for m in range(simulation_duration):
#     s.next_month()
#     print(f"After {m+1:>2} months: {s.alive_goats}, {sum(s.alive_goats)}, {s.active_families}; {s.families[0].goats[0].preg}")
